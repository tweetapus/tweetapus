(async () => {
  ...
  `);
	...
	tweetFrame.addEventListener("load", () => {
		...
		const tweetHTML = `
			<div class="tweet-container" onclick="window.open('${tweet.link}', '_blank')">
				<div class="tweet-header">
					<img src="${tweet.author.avatar}" alt="${tweet.author.name}" style="border-radius: ${tweet.author.avatar_radius || 50}%;" />
					<div class="tweet-header-info">
						<p class="name">
							...
							<span class="tweet-header-username-span">@${tweet.author.username}</span>
					</div>
					<img class="tweetapus-logo" src="${new URL(tweet.link).origin}/public/shared/assets/favicon.svg" alt="Tweetapus logo" width="32" height="32" loading="lazy" draggable="false">
				</div>
				...
				<div class="tweet-footer">
					<div class="tweet-stats">
						<div class="tweet-stat">
							<svg width="19" height="19" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M5.00002 2.54822C8.00003 2.09722 9.58337 4.93428 10 5.87387C10.4167 4.93428 12 2.09722 15 2.54822C18 2.99923 18.75 5.66154 18.75 7.05826C18.75 9.28572 18.1249 10.9821 16.2499 13.244C14.3749 15.506 10 18.3333 10 18.3333C10 18.3333 5.62498 15.506 3.74999 13.244C1.875 10.9821 1.25 9.28572 1.25 7.05826C1.25 5.66154 2 2.99923 5.00002 2.54822Z" stroke="#EC4899" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="${tweet.likes > 0 ? "#EC4899" : "none"}"></path>
							</svg>
					...
					<a href="${tweet.link}" target="_blank" class="tweet-link" onclick="event.stopPropagation()">
						Read ${tweet.replies} ${tweet.replies === 1 ? "reply" : "replies"} on Tweetapus
					</a>
				</div>
			</div>
		`;
